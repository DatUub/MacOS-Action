...
const findIndex_js_1 = tslib_1.__importDefault(require("lodash/findIndex.js"));
...
class MetadataStorage {
    ...
    buildSimpleCommands() {
        this._simpleCommands.forEach((cmd) => {
            ...
            if (cmd.prefix) {
                [...cmd.prefix].forEach((pfx) => {
                    ...
                    mapCmd.forEach((mapCommand) => {
                        if ((0, findIndex_js_1.default)(commands, { name: mapCommand.name }) !== -1) {
            ...
            if ((0, findIndex_js_1.default)(this._simpleCommandsByName, { name: cmd.name }) !== -1) {
                throw Error(`Duplicate simple command name: ${cmd.name}`);
            }
            this._simpleCommandsByName.push({ command: cmd, name: cmd.name });
            cmd.aliases.forEach((al) => {
                if ((0, findIndex_js_1.default)(this._simpleCommandsByName, { name: al }) !== -1) {
